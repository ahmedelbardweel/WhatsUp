...
<head>
    ...
    <title>إنشاء حساب - محادثات</title>
    ...
    <div class="auth-container">
        <div class="auth-box sharp-corners">
            ...
            <form action="/register" method="POST">
                @csrf
                <input type="text" name="name" class="auth-input sharp-corners" placeholder="الاسم" required>
                ...
                <input type="password" name="password_confirmation" class="auth-input sharp-corners" placeholder="تأكيد كلمة المرور" required>
                <button type="submit" class="auth-btn sharp-corners">إنشاء حساب</button>
            </form>
